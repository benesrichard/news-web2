...
layout: fenix
---
## RK - nové ukazatele "Reach", "Kumulativní reach" a "CPRP" a vícenásobný výběr v souhrnu
V Souhrnném okně reachových křivek je nově možné zobrazit ukazatele "Reach", "Kumulativní reach" a "CPRP". Tyto ukazatele nastavíme v "Nastavení souhrnu".
